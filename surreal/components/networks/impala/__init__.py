...
from surreal.components.networks.impala.impala_networks import LargeIMPALANetwork
from surreal.components.networks.impala.impala_networks import SmallIMPALANetwork
