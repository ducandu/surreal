...
#    "rlcore.components.networks."+get_backend()+".variational_auto_encoder"
#)
...
class VariationalAutoEncoder(NeuralNetwork):
    def __init__(self, z_units, encoder_network_spec, decoder_network_spec, **kwargs):
        ...
        self.encoder_network = NeuralNetwork.make(encoder_network_spec, scope="encoder-network")
        self.decoder_network = NeuralNetwork.make(decoder_network_spec, scope="decoder-network")
