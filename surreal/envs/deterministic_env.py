...
class DeterministicEnv(Env):
    ...
    The action space is Int(2). Episodes terminate after always `steps_to_terminal` steps.
    """
    def __init__(self, state_start=0.0, reward_start=-100.0, steps_to_terminal=10):
        ...
        """
        super(DeterministicEnv, self).__init__(state_space=spaces.Float(), action_space=spaces.Int(2))
